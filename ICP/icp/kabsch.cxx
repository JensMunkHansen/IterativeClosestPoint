...
template <typename PointType>
bool Kabsch<PointType>::Update(Matrix3X& _tgt, Matrix3X& _src, Affine3& tx, PointType& rms)
{
  if (_tgt.cols() != _src.cols())
  {
    printf("Kabsch: _tgt.size() != _src.size() (%ld and %ld respectively). Check input data\n",
      _tgt.cols(), _src.cols());
    return false;
  }
