...
vtkStandardNewMacro(vtkImplicitPolyDataDistance2);

//------------------------------------------------------------------------------
vtkImplicitPolyDataDistance2::vtkImplicitPolyDataDistance2()
{
...
//------------------------------------------------------------------------------
void vtkImplicitPolyDataDistance2::SetInput(vtkPolyData* input)
{
  if (this->Input != input)
  {
    ...
    // It is faster with bucket size 1, but then we need normals!!!
...
//------------------------------------------------------------------------------
vtkMTimeType vtkImplicitPolyDataDistance2::GetMTime()
{
...
//------------------------------------------------------------------------------
void vtkImplicitPolyDataDistance2::CreateDefaultLocator()
{
...
//------------------------------------------------------------------------------
double vtkImplicitPolyDataDistance2::EvaluateFunction(double x[3])
{
  double g[3];
  double p[3];
...
//------------------------------------------------------------------------------
double vtkImplicitPolyDataDistance2::EvaluateFunctionAndGetClosestPoint(
...
//------------------------------------------------------------------------------
double vtkImplicitPolyDataDistance2::SharedEvaluate(
...
//------------------------------------------------------------------------------
double vtkImplicitPolyDataDistance2::ClosestPointAndNormal(
						    double x[3], double awnorm[3], double closestPoint[3])
{
  // Set defaults
  double ret = this->NoValue;
  ...
  if (cellId != -1) // point located
  {
    ...
    double dist2, weights[3], pcoords[3];
    cell->EvaluatePosition(p, closestPoint, subId, pcoords, dist2, weights);
...
//------------------------------------------------------------------------------
void vtkImplicitPolyDataDistance2::PrintSelf(ostream& os, vtkIndent indent)
{
